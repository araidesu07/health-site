...
title: "市販発毛剤どれを選んだらいいの？｜現役薬剤師が解説！"
description: "成人男性の壮年性脱毛症に使うミノキシジル5%配合の第1類医薬品4商品を比較。効能・効果と、価格・内容量・ミノキシジル以外の有効成分・容器・購入方法の違いを整理します。"
dateModified: "2026-09-15"
affiliate: true

conclusion:
  issue1: "今回紹介する4商品は、いずれも成人男性（20歳以上）の壮年性脱毛症に使うミノキシジル5%配合の第1類医薬品であり、**抜け毛の進行を抑える、育毛を助けるといった働きだけでなく、毛が生えることまでが承認された成分**です。"
...
issueOne:
  ...
  blocks:
    - title: "「発毛」まで効能・効果として承認されている"
      paragraphs:
        - "今回紹介するミノキシジル5%配合の外用発毛剤4商品は、いずれも成人男性（20歳以上）の壮年性脱毛症に使う第1類医薬品であり、医薬部外品の育毛剤とは区分が異なります。"
        - "注目したいのは、承認された効能・効果に**「発毛」**が含まれている点です。**抜け毛の進行を抑える、育毛を助けるといった働きだけでなく、毛が生えることまでが承認された**成分であることがポイントです。"
      visual:
        type: "key-benefit"
        connector: "＋"
        items:
    ...
    - title: "男性型脱毛症の診療ガイドラインにも記載"
      paragraphs:
        - "5%ミノキシジル外用は、日本皮膚科学会の『男性型および女性型脱毛症診療ガイドライン2017年版』でも、男性型脱毛症に対する外用治療として取り上げられています。"
        - "メーカーによる商品の説明だけでなく、男性型脱毛症の診療を扱う**ガイドラインにも記載されている成分**であることがポイントです。"

    - title: "海外の比較試験でも毛数の増加が報告されている"
      paragraphs:
        - "5%ミノキシジル外用については、成人男性を対象とした海外の比較試験も行われています。有効成分を含まない基剤を使ったプラセボグループと比べ、**5%ミノキシジルを使ったグループでは毛数の増加がより大きかった**と報告されています。"
      visual:
        type: "comparison-evidence"
        heading: "海外の成人男性を対象とした比較試験"
        connector: "vs"
        items:
          - label: "有効成分を含まない基剤"
          - label: "5%ミノキシジル"
        finding: "5%ミノキシジル群で、毛数の増加がより大きかったと報告"

    - title: "ここまでのまとめ"
      paragraphs:
        - "効能・効果として**『発毛』まで承認**されていること、**診療ガイドラインでの紹介**、そして**研究試験におけるプラセボと比べた毛数の増加**。ミノキシジル5%の外用発毛剤には、こうした3つの裏づけがあります。"
...
products:
  ...
  - productId: "rohto-regro-ex5-energy-60"
    ...
    volume: "60mL"
    keyPoint: "60mL・希望小売価格5,940円。店頭でも買える"
    affiliateProvider: "a8-rakuten"
