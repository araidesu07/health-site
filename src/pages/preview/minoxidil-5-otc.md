...
title: "市販発毛剤どれを選んだらいいの？"
description: "成人男性の壮年性脱毛症に使うミノキシジル5%配合の第1類医薬品4商品を比較。効能・効果と、価格・内容量・ミノキシジル以外の有効成分・容器・購入方法の違いを整理します。"
datePublished: "2026-09-17"
dateModified: "2026-09-17"
affiliate: true

conclusion:
  issue1: "ミノキシジル5%は、成人男性（20歳以上）の壮年性脱毛症に使う第1類医薬品で、効能・効果に「発毛」が含まれます。今回紹介する4商品は、いずれもこのミノキシジル5%配合です。"

issueOne:
  title: "壮年性脱毛症に使う、発毛を目的とした第1類医薬品"
  blocks:
    - title: "ミノキシジル5%は「発毛」も効能・効果に含む医薬品"
      order: ["keyPoint", "paragraphs", "visual"]
      keyPoint:
        label: "承認された効能・効果"
        text: "「壮年性脱毛症における発毛、育毛及び脱毛（抜け毛）の進行予防。」"
      visual:
        type: "key-benefit"
        connector: "＋"
        caption: "この一文に含まれているもの"
        items:
          - label: "育毛"
          - label: "抜け毛の進行予防"
          - label: "発毛"
            highlight: true
        note: "内容を3つに分けたもので、承認された文言の並びとは異なります。いずれにも「壮年性脱毛症における」という条件が付きます。"
      paragraphs:
        - "ミノキシジル5%製剤は、成人男性（20歳以上）の壮年性脱毛症に使う第1類医薬品です。効能・効果には、「育毛」「抜け毛の進行予防」に加えて**「発毛」**が含まれます。"

    - title: "「発毛」という効能・効果"
      paragraphs:
        - "ミノキシジル5%製剤では、成人男性（20歳以上）の壮年性脱毛症に対する効能・効果に「発毛」が含まれます。「発毛」は、毛が生えることを表す言葉です。"

    - title: "効能・効果の書き方が、区分で違う"
      visual:
        type: "comparison-table"
        caption: "効能・効果の書き方が違う"
        columns:
          - "ミノキシジル5%の外用発毛剤"
          - "育毛剤"
        columnTags:
        ...
        rows:
          ...
          - label: "効能・効果"
            values:
              - "壮年性脱毛症における発毛、育毛、脱毛の進行予防"
              - "育毛、脱毛の予防、発毛促進など（製品ごと）"
      paragraphs:
        - "成人男性の壮年性脱毛症に対するミノキシジル5%製剤の効能・効果には、**「発毛」**が含まれます。"

    - title: "市販の第1類医薬品として買える"
      paragraphs:
        - "ミノキシジル5%製剤は第1類医薬品で、薬剤師が在籍する店舗や通販で購入し、自宅で使用する外用薬です。"
      lists:
        - title: "使用できない方"
          items:
            - "本剤の成分でアレルギー症状を起こしたことがある方"
            - "女性"
            - "20歳未満の方"
            - "壮年性脱毛症以外の脱毛症の方"
            - "脱毛の原因がわからない方"
    ...
    - title: "ここまでのまとめ"
      variant: "summary"
      paragraphs:
        - "ミノキシジル5%は、成人男性の壮年性脱毛症に対して、「育毛」「抜け毛の進行予防」に加え、「発毛」も効能・効果に含まれる第1類医薬品です。"
      next:
        title: "では、どの商品を選ぶ？"
        text: "次は、今回紹介する4商品の違いを比べます。"
...
products:
  - productId: "angfa-scalpd-medical-minoki5-premium-60"
    ...
    overview:
      - "クッションラバーヘッドを採用し、頭皮に押し当ててタップしながら塗るタイプです。"
...
purchaseNotes:
  ...
  - "女性や20歳未満の方のほか、壮年性脱毛症以外の脱毛症（円形脱毛症など）の方、脱毛の原因がわからない方、脱毛が急激な方や髪が斑状に抜けている方は使用できません。体質や持病によっては、使用前に相談が必要な場合があります。"
  - "毛髪が成長するには時間がかかるため、効果がわかるようになるまで少なくとも4か月間、1日2回の使用を続けるよう案内されています。"
  - "毛髪が成長する程度には個人差があり、すべての方に効果があるわけではありません。"
...
sources:
  ...
  - label: "REGRO 公式ストア（リグロEX5エナジー）"
    ...
    checkedAt: "2026-09-11"
  - label: "医薬品、医療機器等の品質、有効性及び安全性の確保等に関する法律 第2条（医薬品・医薬部外品の定義）"
    url: "https://laws.e-gov.go.jp/api/1/articles;lawNum=昭和三十五年法律第百四十五号;article=2"
    checkedAt: "2026-09-16"
  - label: "厚生労働省医薬・生活衛生局監視指導・麻薬対策課長通知「医薬品等適正広告基準の解説及び留意事項等について」（平成29年9月29日 薬生監麻発0929第5号）別紙（医薬部外品の効能・効果の範囲）"
    url: "https://www.mhlw.go.jp/file/06-Seisakujouhou-11120000-Iyakushokuhinkyoku/0000179263.pdf"
    checkedAt: "2026-09-16"
  - label: "リアップX5チャージ 添付文書（大正製薬 公式製品カタログ掲載）"
    url: "https://www.catalog-taisho.com/content/dam/selfmedication/jp/ja/riup/images/05804/pdf/05804_ProductPDF_jp.pdf"
    checkedAt: "2026-09-17"
  - label: "Minoプラス 添付文書（東和薬品 公式通販サイト掲載）"
    url: "https://shop.towayakuhin.co.jp/assets/img/common/minoplus_PackageInserts.pdf"
    checkedAt: "2026-09-17"
  - label: "リグロEX5エナジー 添付文書（ロート製薬 公式サイト掲載）"
    url: "https://jp.rohto.com/-/media/com/regro/ex5energy/4987241197408.pdf"
    checkedAt: "2026-09-17"

priceNote: "価格は2026年9月11日時点で各メーカー公式が提示している税込価格です。価格の種別は商品によって異なり、店頭やリンク先通販サイトの販売価格とは異なる場合があります。"
---
